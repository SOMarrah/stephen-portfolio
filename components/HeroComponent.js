...
export default function HeroComponent({scrollToTop, handleClick}) {
  ...
  return (
    <div ref={scrollToTop} style={{display:"flex", justifyContent: "center", alignItems: "center", overflow:"hidden"}}>
        <div style={{height: "100vh", width:"100vw", overflow:"hidden", position:"relative", display:"block"}}>
            <Image src="/images/energyspiral.gif" alt="energy spiral gif" placeholder={"blur"} blurDataURL="/images/energyspiral.gif"  fill style={{zIndex: "-1", scale:"140%", position: "absolute",inset: "0px",objectFit: "contain",objectPosition: "center top", color: "transparent"}} priority={"true"}/>
        </div>
